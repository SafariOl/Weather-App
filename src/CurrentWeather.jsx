    ...
    <div className='current'>
      <div className='temerature-block'>
        ...
        <div className="temperature">
          <div>{current.temp}<sup>o<sub>c</sub></sup></div>
          <img src={current.weather} className='weather-name'></img>
        </div>
        <p style={{textTransform: 'capitalize'}}>{current.weatherName}</p>
      </div>
      <div style={{marginTop: 20}}>
        ...
        <div style={{display: 'flex', alignItems: 'center', gap: 10}}><FontAwesomeIcon icon={faCalendar} /><p style={{textTransform: 'capitalize'}}>{current.location}</p></div>
      </div>
    </div>
  )
}
